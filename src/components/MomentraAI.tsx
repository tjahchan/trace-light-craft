  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 h-12 w-12 rounded-full flex items-center justify-center backdrop-blur-xl bg-black/60 border border-white/[0.15] shadow-[0_0_20px_rgba(99,102,241,0.15)] hover:shadow-[0_0_30px_rgba(99,102,241,0.3)] transition-all duration-300 group"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-50 w-[420px] h-[580px] max-w-[calc(100vw-2rem)] max-h-[calc(100vh-6rem)] backdrop-blur-2xl bg-black/80 border border-white/[0.12] rounded-2xl shadow-2xl flex flex-col overflow-hidden"
          >
            {/* Header */}
