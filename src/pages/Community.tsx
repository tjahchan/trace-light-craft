      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Top performers across the Momentra community
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="backdrop-blur-xl bg-card/60 border border-border rounded-2xl overflow-hidden">
          ...
          <div className="px-5 py-4 border-b border-border">
            <div className="flex rounded-full bg-secondary p-0.5 text-xs max-w-xs">
              <button
                onClick={() => setActiveTab("streak")}
                className={`flex items-center gap-1.5 px-4 py-2 rounded-full font-medium transition-all flex-1 justify-center ${
                  activeTab === "streak"
                    ? "bg-primary text-primary-foreground shadow-sm"
                    : "text-muted-foreground hover:text-foreground"
                }`}
              >
                <Flame className="h-3.5 w-3.5" /> Journal Streak
              </button>
              <button
              ...
              >
                <TrendingUp className="h-3.5 w-3.5" /> Monthly PnL
              </button>
            </div>
          </div>
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                {activeTab === "pnl"
                  ...
                  : "No active streaks yet. Start journaling to claim your spot!"}
              </p>
            </div>
          ) : (
            <>
                  ...
                  <div
                    ...
                    className={`relative rounded-2xl p-4 text-center border transition-all ${
                      idx === 0
                        ...
                        : idx === 1
                        ? "border-gray-300/20 bg-gray-300/[0.03]"
                        : "border-amber-600/20 bg-amber-600/[0.03]"
                    }`}
                  >
                    <span className="text-2xl">{rankBadge(idx + 1)}</span>
        ...
        <div className="backdrop-blur-xl bg-card/60 border border-border rounded-2xl overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">Community Chat</p>
                <p className="text-[10px] text-muted-foreground">Share ideas, setups, and discuss markets</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] text-muted-foreground">{posts.length} messages</span>
              <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform ${showChat ? "rotate-180" : ""}`} />
            </div>
          </button>
          ...
          <AnimatePresence>
            {showChat && (
              ...
              >
                <ScrollArea className="px-4 py-3" style={{ maxHeight: 500 }} ref={scrollRef}>
